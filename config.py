...
class Config(object):
    ...
    TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7479227005:AAEHDWOhE6HI4y2MFzk14vVtoMZ_2oOV3_w")
    ...
    LAZY_DEVELOPER = set(int(x) for x in os.environ.get("LAZY_ADMIN", "5300021755").split())
